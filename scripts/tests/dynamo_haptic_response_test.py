...
g1_sub = rospy.Subscriber('/chai/env/Gripper1/State', ObjectState, g1_cb, queue_size=1)
g2_sub = rospy.Subscriber('/chai/env/Gripper2/State', ObjectState, g2_cb, queue_size=1)
w_sub = rospy.Subscriber('/chai/env/World/State', WorldState, w_cb, queue_size=1)
w_pub = rospy.Publisher('/chai/env/World/Command', WorldCmd, queue_size=1)
g1_mean = []
g1_data = []
g2_data = []
g2_mean = []
